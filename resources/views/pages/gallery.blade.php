...
@section('meta_title', __('general.gallery') . ' - ' . __('general.site_name'))
...
<section class="relative pt-32 pb-20 bg-gradient-to-br from-primary-900 to-dark-900">
    ...
    <div class="container-custom relative z-10">
        <span class="inline-block px-4 py-1.5 bg-white/10 text-white/90 rounded-full text-sm font-semibold mb-6 backdrop-blur-sm border border-white/20">{{ __('general.gallery') }}</span>
        <h1 class="text-5xl lg:text-6xl font-bold text-white mb-4">{{ __('general.gallery') }}</h1>
        <p class="text-xl text-white/70 max-w-2xl">Visual stories from our most breathtaking destinations.</p>
    </div>
</section>
